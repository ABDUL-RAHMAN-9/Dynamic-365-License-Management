...
export default function NavBar()
{
    return (
        <div className="bg-[#06163a] text-white flex items-center px-4 py-2 min-h-[48px] justify-between">
            {/* Left section: Apps icon and branding */}
            <div className="flex items-center gap-2">
                <AppsIcon className="text-lg mr-2" />
                <span className="font-bold text-base">Dynamics 365</span>
                <span className="text-gray-300 text-sm ml-2">| Analytics</span>
            </div>
            ...
            <div className="flex items-center gap-5">
                ...
                <div className="rounded-full border border-gray-200 text-l px-2 py-1 ml-2" style={{ minWidth: "44px", minHeight: "44px", display: "flex", alignItems: "center", justifyContent: "center" }}>
                    AR
                </div>
            </div>
        </div>
